...
import { CreateTaskForm } from '@/framework/features/create-tasks/presentation/components/CreateTaskForm'
import { renderWithTheme as render } from '@/test/renderWithTheme'

const createTaskMock = vi.hoisted(() => vi.fn())
const toastMock = vi.hoisted(() => ({ success: vi.fn(), error: vi.fn() }))

vi.mock('@/framework/features/create-tasks/presentation/actions/createTask.action', () => ({ createTask: createTaskMock }))
